...
import com.longlong.jpastudy.vo.Item;
...
public class JpaMain {
    ...
    private static void print(Member memberA) {

        StringBuffer sb = new StringBuffer();
        sb.append("■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■\r\n" +
                " member name = " + memberA.getName() + "\r\n" +
                "city = " + memberA.getCity() + "\r\n" +
                "street = " + memberA.getStreet() + "\r\n" +
                "order size = " + memberA.getOrders().size() + "\r\n" +
                "■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■"
        );

        System.out.println(sb.toString());

        memberA.getOrders().forEach(
                System.out::println
        );
    }
}
